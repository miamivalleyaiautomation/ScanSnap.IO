        ...
        <div className="container hero-grid">
          ...
          <div>
            <div className="device">
              ...
              {/* Placeholder GIF (you can swap the path later) */}
          ...
          <div className="pricing-grid">
            ...
            <div className="card">
              <div>
                ...
                <h3>
                  $9.99 <span className="muted">/ user / mo</span>
                </h3>
                <p className="muted">
            ...
            <div className="card">
              <div>
                ...
                <h3>
                  $14.99 <span className="muted">/ user / mo</span>
                </h3>
            ...
            <div className="card">
              <div>
                ...
                <h3>
                  $49.99 <span className="muted">/ user / mo</span>
                </h3>
                <p className="muted">
